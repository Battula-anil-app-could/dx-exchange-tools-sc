...
// use dharitri_sc_snippets::erdrs::wallet::Wallet;
// use dharitri_sc_snippets::dharitri_sc_scenario::scenario_format::interpret_trait::InterpreterContext;
// use dharitri_sc_snippets::dharitri_sc_scenario::scenario_model::IntoBlockchainCall;
...
//     },
//     dharitri_sc_scenario::{bech32, ContractInfo, DebugApi},
//     tokio, Interactor,
// };

// const GATEWAY: &str = dharitri_sc_snippets::erdrs::blockchain::DEVNET_GATEWAY;
...
//         let result: dharitri_sc_snippets::InteractorResult<PlaceholderOutput> = self
//             .interactor
//             .sc_call_get_result(
//                 self.contract
...
//         let _: dharitri_sc_snippets::InteractorResult<()> = self
//             .interactor
//             .sc_call_get_result(
//                 self.contract
//                     .add_farms(farms)
