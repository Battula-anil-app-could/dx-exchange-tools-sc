...
use dharitri_sc::{codec::Empty, types::DctTokenPayment};
...
fn enter_lp_through_pos_creator_test() {
    ...
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, LP_TOKEN_IDS[2], &rust_biguint!(181_818_181));
    ...
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[1], &rust_biguint!(181_818_181));
...
fn enter_lp_and_farm_through_pos_creator() {
    ...
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[0], &rust_biguint!(47_164_502));
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[1], &rust_biguint!(0));
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[2], &rust_biguint!(270_000_000));
}
...
fn enter_lp_farm_and_metastaking_through_pos_creator_test() {
    ...
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[0], &rust_biguint!(264_410));
    b_mock
        .borrow()
        .check_dct_balance(&user_addr, TOKEN_IDS[1], &rust_biguint!(31_935_484));
    b_mock
        .borrow()
